...
* [libxutils](https://github.com/kala13x/libxutils) ⭐ 75 | 🐛 0 | 🌐 C | 📅 2026-02-06 - Simple and yet powerful cross-platform C library providing data structures, algorithms and much more. \[MIT]
...
* [Tonic](https://github.com/TonicAudio/Tonic) ⭐ 551 | 🐛 53 | 🌐 C++ | 📅 2024-12-24 - Easy and efficient audio synthesis in C++. \[Unlicense]
...
* [Vcflib](https://github.com/ekg/vcflib) ⭐ 666 | 🐛 16 | 🌐 C++ | 📅 2025-10-31 - A C++ library for parsing and manipulating VCF files. \[MIT]
...
* [args](https://github.com/taywee/args) ⭐ 1,591 | 🐛 16 | 🌐 C++ | 📅 2026-01-31 - A simple header-only C++ argument parser library. \[MIT]
...
* [tuibox](https://github.com/Cubified/tuibox) ⭐ 271 | 🐛 4 | 🌐 C | 📅 2023-12-01 - A single-header terminal UI (TUI) library, capable of creating mouse-driven, interactive applications on the command line. \[MIT]
...
* [matplotplusplus](https://github.com/alandefreitas/matplotplusplus) ⭐ 4,801 | 🐛 75 | 🌐 C++ | 📅 2025-12-01 - C++ Graphics Library for Data Visualization. \[MIT] [website](https://alandefreitas.github.io/matplotplusplus/)
...
* [kissfft](https://github.com/mborgerding/kissfft) ⭐ 1,849 | 🐛 37 | 🌐 C | 📅 2026-01-31 - A Fast Fourier Transform (FFT) library that tries to Keep it Simple, Stupid. \[BSD-3-Clause]
* [iir1](https://github.com/berndporr/iir1) ⭐ 744 | 🐛 0 | 🌐 C++ | 📅 2025-07-07 - IIR Realtime C++ filter library. \[MIT]
...
* [C-Turtle](https://github.com/walkerje/C-Turtle) ⭐ 81 | 🐛 3 | 🌐 C++ | 📅 2025-02-06 - A C++11 header-only turtle graphics library acting as a CImg wrapper. \[MIT]
...
* [libspng](https://github.com/randy408/libspng) ⭐ 821 | 🐛 81 | 🌐 C | 📅 2024-06-15 - Simple, modern libpng alternative. \[BSD-2] [website](https://libspng.org/)
...
* \[Jpegli]\[<https://github.com/google/jpegli> ⭐ 308 | 🐛 37 | 🌐 C++ | 📅 2025-10-27] - an improved JPEG encoder and decoder implementation. \[BSD-3-Clause]
...
* [PlutoFilter](https://github.com/sammycage/plutofilter) ⭐ 195 | 🐛 2 | 🌐 C | 📅 2025-08-02 - A single-header, zero-allocation image filter library in C. \[MIT]
...
* [DAW JSON Link](https://github.com/beached/daw_json_link) ⭐ 499 | 🐛 18 | 🌐 C++ | 📅 2026-02-04 - Fast, convenient JSON serialization and parsing in C++. \[BSL-1.0]
...
* [ng-log](https://github.com/ng-log/ng-log) ⭐ 89 | 🐛 2 | 🌐 C++ | 📅 2026-01-18 - C++14 library for application-level logging. \[BSD-3-Clause]
...
* [UCall](https://github.com/unum-cloud/ucall) ⭐ 1,304 | 🐛 13 | 🌐 C | 📅 2025-09-16 - A high-performance SIMD-accelerated RPC library on io\_uring. \[Apache2]
...
* [BitSerializer](https://github.com/PavelKisliak/BitSerializer) ⭐ 27 | 🐛 0 | 🌐 C++ | 📅 2026-01-24 - Multi-format serialization library (JSON, XML, YAML, CSV, MsgPack) \[MIT]
...
* [Mini-XML](https://github.com/michaelrsweet/mxml) ⭐ 503 | 🐛 7 | 🌐 C | 📅 2025-12-19 - A small XML parsing library written in ANSI C. \[LGPL2 with exceptions]
...
* [fast\_io](https://github.com/cppfastio/fast_io) ⭐ 832 | 🐛 45 | 🌐 C++ | 📅 2026-01-19 - Significantly faster input/output for C++20. \[MIT]
* [rapidhash](https://github.com/Nicoshev/rapidhash) ⭐ 754 | 🐛 10 | 🌐 C++ | 📅 2026-02-06 - Very fast, high quality, platform-independent hashing algorithm. \[BSD-2-Clause]
