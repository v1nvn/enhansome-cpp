...
* [Folly](https://github.com/facebook/folly) ⭐ 30,251 | 🐛 445 | 🌐 C++ | 📅 2026-02-08 - An open-source C++ library developed and used at Facebook. \[Apache2]
* [abseil-cpp](https://github.com/abseil/abseil-cpp) ⭐ 17,019 | 🐛 213 | 🌐 C++ | 📅 2026-02-06 - Abseil C++ Common Libraries. \[Apache2]
* [Dlib](https://github.com/davisking/dlib) ⭐ 14,326 | 🐛 43 | 🌐 C++ | 📅 2026-02-05 :zap: - A toolkit for making real world machine learning and data analysis applications in C++. \[Boost] [website](http://dlib.net/)
...
* [OpenFrameworks](https://github.com/openframeworks/openFrameworks) ⭐ 10,322 | 🐛 1,057 | 🌐 C++ | 📅 2026-02-06 - A cross platform open source toolkit for creative coding in C++. \[MIT] [website](http://www.openframeworks.cc/)
* [EASTL](https://github.com/electronicarts/EASTL) ⭐ 9,141 | 🐛 110 | 🌐 C++ | 📅 2025-11-15 - Electronic Arts Standard Template Library. \[BSD]
* [Seastar](https://github.com/scylladb/seastar) ⭐ 9,115 | 🐛 523 | 🌐 C++ | 📅 2026-02-08 - An advanced, open-source C++ framework for high-performance server applications on modern hardware. \[Apache-2.0 License] [seastar.io](http://seastar.io/)
* [JUCE](https://github.com/julianstorer/JUCE) ⭐ 8,050 | 🐛 440 | 🌐 C++ | 📅 2026-02-06 - An all-encompassing C++ class library for developing cross-platform software. \[Core-Module: ISC, Rest: GPL2/GPL3/Proprietary] [website](http://www.juce.com/)
...
* [ETL](https://github.com/ETLCPP/etl) ⭐ 2,859 | 🐛 62 | 🌐 C++ | 📅 2026-02-08 - Embedded Template Library. \[MIT]
...
* [BDE](https://github.com/bloomberg/bde) ⭐ 1,795 | 🐛 15 | 🌐 C++ | 📅 2026-02-06 - The BDE Development Environment from Bloomberg Labs. \[Apache2]
...
* [xtd](https://github.com/gammasoft71/xtd) ⭐ 1,127 | 🐛 99 | 🌐 C++ | 📅 2026-02-08 - Modern C++20 framework to create console (CLI), forms (GUI) and unit tests (xUnit) applications on Windows, macOS, Linux, iOS, Android, FreeBSD and Haiku. \[MIT]
...
* [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 193,667 | 🐛 3,344 | 🌐 C++ | 📅 2026-02-09 - An open source software library for numerical computation using data flow graphs. \[Apache]
* [PyTorch](https://github.com/pytorch/pytorch) ⭐ 97,258 | 🐛 18,016 | 🌐 Python | 📅 2026-02-09 - Tensors and Dynamic neural networks in Python with strong GPU acceleration. [website](https://pytorch.org)
...
* [CNTK](https://github.com/Microsoft/CNTK) ⭐ 17,616 | 🐛 839 | 🌐 C++ | 📅 2023-03-11 - Microsoft Cognitive Toolkit (CNTK), an open source deep-learning toolkit. \[Boost]
...
* [oneDNN](https://github.com/oneapi-src/oneDNN) ⭐ 3,960 | 🐛 141 | 🌐 C++ | 📅 2026-02-09 - An open-source cross-platform performance library for deep learning applications. \[Apache] [website](https://01.org/onednn)
...
* [libuv](https://github.com/libuv/libuv) ⭐ 26,554 | 🐛 214 | 🌐 C | 📅 2026-02-05 - Cross-platform asynchronous I/O. \[BSD]
* [libhv](https://github.com/ithewei/libhv) ⭐ 7,468 | 🐛 58 | 🌐 C | 📅 2026-02-02 - Cross-platform event loop library. \[BSD]
* [Asio](https://github.com/chriskohlhoff/asio/) ⭐ 5,742 | 🐛 1,050 | 🌐 C++ | 📅 2025-11-30 - A cross-platform C++ library for network and low-level I/O programming that provides developers with a consistent asynchronous model using a modern C++ approach. \[Boost] [website](http://think-async.com/)
* [C++ Actor Framework](https://github.com/actor-framework/actor-framework) ⭐ 3,389 | 🐛 60 | 🌐 C++ | 📅 2026-02-08 - An Open Source Implementation of the Actor Model in C++. \[BSD-3-Clause] [website](http://actor-framework.org/)
...
* [miniaudio](https://github.com/mackron/miniaudio) ⭐ 6,306 | 🐛 4 | 🌐 C | 📅 2026-02-08 - Single file audio playback and capture library. \[Unlicense] [website](https://miniaud.io/)
* [rnnoise](https://github.com/xiph/rnnoise) ⭐ 5,347 | 🐛 201 | 🌐 C | 📅 2025-02-22 - Recurrent neural network for audio noise reduction. \[BSD-3-Clause]
* [Aubio](https://github.com/aubio/aubio) ⭐ 3,627 | 🐛 157 | 🌐 C | 📅 2025-11-20 - A library for audio and music analysis.\[GPL-3.0] [website](https://aubio.org/)
* [audioFlux](https://github.com/libAudioFlux/audioFlux) ⭐ 3,262 | 🐛 16 | 🌐 C | 📅 2024-05-24 - A C library for audio and music analysis, feature extraction. \[MIT]
...
* [libtorrent](https://github.com/arvidn/libtorrent) ⭐ 5,843 | 🐛 217 | 🌐 C++ | 📅 2026-02-03 (a.k.a. libtorrent-rasterbar) - An efficient feature complete C++ bittorrent implementation. \[BSD]
...
* [gromacs](https://github.com/gromacs/gromacs) ⭐ 869 | 🐛 0 | 🌐 C++ | 📅 2026-02-05 - A message-passing parallel molecular dynamics implementation. \[GPL] [website](http://www.gromacs.org)
...
* [FTXUI](https://github.com/ArthurSonzogni/FTXUI) ⭐ 9,631 | 🐛 96 | 🌐 C++ | 📅 2026-02-09 - C++ Functional Terminal User Interface. \[MIT]
* [cxxopts](https://github.com/jarro2783/cxxopts) ⭐ 4,691 | 🐛 77 | 🌐 C++ | 📅 2026-02-05 - Lightweight C++ command line option parser. \[MIT]
* [linenoise](https://github.com/antirez/linenoise) ⭐ 4,178 | 🐛 145 | 🌐 C | 📅 2026-01-10 - A small self-contained alternative to readline and libedit. \[BSD-2-Clause]
* [CLI11](https://github.com/CLIUtils/CLI11) ⭐ 4,135 | 🐛 66 | 🌐 C++ | 📅 2026-02-03 - Header only single or multi-file C++11 library for simple and advanced CLI parsing. \[BSD]
...
* [tabulate](https://github.com/p-ranav/tabulate) ⭐ 2,142 | 🐛 42 | 🌐 C++ | 📅 2025-05-14 - Table Maker for Modern C++. \[MIT]
* [termbox](https://github.com/nsf/termbox) ⭐ 2,003 | 🐛 20 | 🌐 C | 📅 2020-08-25 - A C library for writing text-based user interfaces. \[MIT]
* [args](https://github.com/taywee/args) ⭐ 1,592 | 🐛 16 | 🌐 C++ | 📅 2026-01-31 - A simple header-only C++ argument parser library. \[MIT]
...
* [FINAL CUT](https://github.com/gansm/finalcut) ⭐ 1,143 | 🐛 9 | 🌐 C++ | 📅 2026-02-07 - Library for creating terminal applications with text-based widgets. \[LGPL]
...
* [Lyra](https://github.com/bfgroup/Lyra) ⭐ 568 | 🐛 17 | 🌐 C++ | 📅 2026-01-29 - A simple to use, composable, command line parser for C++ 11 and beyond. \[Boost]
...
* [zstd](https://github.com/facebook/zstd) ⭐ 26,578 | 🐛 255 | 🌐 C | 📅 2026-02-01 - Zstandard - Fast real-time compression algorithm. Developed by Facebook. \[BSD]
* [Brotli](https://github.com/google/brotli) ⭐ 14,571 | 🐛 90 | 🌐 TypeScript | 📅 2025-12-18 - Brotli compression format. Developed by Google. \[MIT]
* [LZ4](https://github.com/lz4/lz4) ⭐ 11,635 | 🐛 60 | 🌐 C | 📅 2026-02-01 - Extremely Fast Compression algorithm. \[BSD] [website](http://www.lz4.org/)
* [libarchive](https://github.com/libarchive/libarchive) ⭐ 3,404 | 🐛 549 | 🌐 C | 📅 2026-01-26 - Multi-format archive and compression library. \[New BSD] [website](http://www.libarchive.org/)
* [miniz](https://github.com/richgel999/miniz) ⭐ 2,638 | 🐛 140 | 🌐 C++ | 📅 2026-02-03 - Single C source file Deflate/Inflate compression library with zlib-compatible API, ZIP archive reading/writing, PNG writing. \[MIT]
* [zlib-ng](https://github.com/zlib-ng/zlib-ng) ⭐ 1,935 | 🐛 53 | 🌐 C | 📅 2026-02-08 - zlib for the "next generation" systems. Drop-In replacement with some serious optimizations. \[zlib]
...
* [Minizip](https://github.com/nmoinvaz/minizip) ⭐ 1,425 | 🐛 23 | 🌐 C | 📅 2026-02-04 - Zlib with latest bug fixes that supports PKWARE disk spanning, AES encryption, and IO buffering. \[zlib]
* [minizip-ng](https://github.com/zlib-ng/minizip-ng) ⭐ 1,425 | 🐛 23 | 🌐 C | 📅 2026-02-04 - Fork of the popular zip manipulation library found in the zlib distribution. \[zlib]
...
* [bit7z](https://github.com/rikyoz/bit7z) ⭐ 808 | 🐛 64 | 🌐 C++ | 📅 2026-02-08 - A C++ static library offering a clean and simple interface to the 7-zip shared libraries. \[MPL2]
...
* [Kanzi](https://github.com/flanglet/kanzi-cpp) ⭐ 198 | 🐛 0 | 🌐 C++ | 📅 2026-02-08 - a modern, modular, portable and efficient lossless data compressor implemented in C++. \[Apache-2.0]
...
* [concurrentqueue](https://github.com/cameron314/concurrentqueue) ⭐ 12,046 | 🐛 74 | 🌐 C++ | 📅 2026-02-08 - A fast multi-producer, multi-consumer lock-free concurrent queue for C++11. \[BSD,Boost]
* [Taskflow](https://github.com/taskflow/taskflow) ⭐ 11,704 | 🐛 25 | 🌐 C++ | 📅 2026-02-03 - A General-purpose Parallel and Heterogeneous Task Programming System. (renamed from Cpp-Taskflow) \[MIT]
...
* [NCCL](https://github.com/NVIDIA/nccl) ⭐ 4,440 | 🐛 286 | 🌐 C++ | 📅 2026-02-03 - Optimized primitives for collective multi-GPU communication. \[BSD]
...
* [HPX](https://github.com/STEllAR-GROUP/hpx/) ⭐ 2,785 | 🐛 169 | 🌐 C++ | 📅 2026-02-09 - A general purpose C++ runtime system for parallel and distributed applications of any scale. \[Boost]
...
* [libcds](https://github.com/khizmax/libcds) ⭐ 2,727 | 🐛 53 | 🌐 C++ | 📅 2023-10-17 - A C++ library of Concurrent Data Structures. \[BSD]
* [ck](https://github.com/concurrencykit/ck) ⭐ 2,605 | 🐛 9 | 🌐 C | 📅 2026-02-08 - Concurrency primitives, safe memory reclamation mechanisms and non-blocking data structures. \[BSD]
...
* [Kokkos](https://github.com/kokkos/kokkos) ⭐ 2,444 | 🐛 570 | 🌐 C++ | 📅 2026-02-09 - A performance portable programming model for parallel execution and memory abstraction. \[BSD]
...
* [Neco](https://github.com/tidwall/neco) ⭐ 1,322 | 🐛 6 | 🌐 C | 📅 2024-07-26 - Concurrency library for C (coroutines). \[MIT]
...
* [libfork](https://github.com/ConorWilliams/libfork) ⭐ 817 | 🐛 9 | 🌐 C++ | 📅 2026-02-08 - A bleeding-edge, lock-free, wait-free, continuation-stealing tasking library built on C++20's coroutines. \[MPL-2.0] [website](https://conorwilliams.github.io/libfork/)
...
* [TooManyCooks](https://github.com/tzcnt/TooManyCooks/) ⭐ 170 | 🐛 16 | 🌐 C++ | 📅 2026-02-09 - High-performance C++20 coroutine framework with advanced hardware detection features. \[BSL-1.0]
...
* [simpleini](https://github.com/brofield/simpleini) ⭐ 1,275 | 🐛 1 | 🌐 C++ | 📅 2025-11-13 - Cross-platform C++ library providing a simple API to read and write INI-style configuration files. \[MIT]
...
* [hat-trie](https://github.com/Tessil/hat-trie) ⭐ 855 | 🐛 13 | 🌐 C++ | 📅 2025-11-11 - C++ implementation of a fast and memory efficient HAT-trie. \[MIT]
...
* [OpenSSL](https://github.com/openssl/openssl) ⭐ 29,534 | 🐛 1,633 | 🌐 C | 📅 2026-02-08 - A robust, commercial-grade, full-featured, and Open Source cryptography library. \[Apache] [website](http://www.openssl.org/)
...
* [libsodium](https://github.com/jedisct1/libsodium) ⭐ 13,437 | 🐛 1 | 🌐 C | 📅 2026-02-08 - P(ortable|ackageable) NaCl-based crypto library, opinionated and easy to use. \[ISC]
* [mbedTLS](https://github.com/ARMmbed/mbedtls) ⭐ 6,460 | 🐛 1,567 | 🌐 C | 📅 2026-02-03 - An open source, portable, easy to use, readable and flexible SSL library, previously known as PolarSSL. \[Apache2] [website](https://tls.mbed.org/)
...
* [Tiny AES in C](https://github.com/kokke/tiny-AES-c) ⭐ 4,854 | 🐛 33 | 🌐 C | 📅 2024-10-04 - Small portable AES128/192/256 in C. \[PublicDomain]
* [s2n](https://github.com/awslabs/s2n) ⭐ 4,687 | 🐛 296 | 🌐 C | 📅 2026-02-09 - An implementation of the TLS/SSL protocols. \[Apache]
...
* [Glaze](https://github.com/stephenberry/glaze) ⭐ 2,374 | 🐛 33 | 🌐 C++ | 📅 2026-02-06 - High performance, header only, CSV library with reflection support. \[MIT]
...
* [commata](https://github.com/furfurylic/commata) ⭐ 18 | 🐛 0 | 🌐 C++ | 📅 2026-02-09 - Just another header-only C++17 CSV parser. \[Unlicense]

## Database

*Database Libraries, SQL Servers, ODBC Drivers, and Tools*

* [LevelDB](https://github.com/google/leveldb) ⭐ 38,811 | 🐛 371 | 🌐 C++ | 📅 2025-01-30 - A fast key-value storage library written at Google that provides an ordered mapping from string keys to string values. \[BSD]
* [RocksDB](https://github.com/facebook/rocksdb) ⭐ 31,526 | 🐛 1,404 | 🌐 C++ | 📅 2026-02-06 - Embedded key-value store for fast storage from facebook. \[BSD]
* [Hiredis](https://github.com/redis/hiredis) ⭐ 6,683 | 🐛 70 | 🌐 C | 📅 2025-11-08 - A minimalistic C client library for the Redis database. \[BSD]
* [Infinity](https://github.com/infiniflow/infinity) ⭐ 4,380 | 🐛 142 | 🌐 C++ | 📅 2026-02-06 - The AI-native database built for LLM applications, providing incredibly fast vector and full-text search. \[Apache2]
...
* [Velox](https://github.com/facebookincubator/velox) ⭐ 4,053 | 🐛 1,365 | 🌐 C++ | 📅 2026-02-09 - A C++ vectorized database acceleration library aimed to optimizing query engines and data processing systems. \[Apache-2.0] [website](https://velox-lib.io/)
...
* [SQLiteC++](https://github.com/SRombauts/SQLiteCpp) ⭐ 2,641 | 🐛 90 | 🌐 C | 📅 2026-02-08 - SQLiteC++ (SQLiteCpp) is a smart and easy to use C++ SQLite3 wrapper. \[MIT]
...
* [libpqxx](https://github.com/jtv/libpqxx) ⭐ 1,276 | 🐛 8 | 🌐 C++ | 📅 2026-02-09 - The official C++ client API for PostgreSQL. \[BSD-3-Clause]
...
* [MongoDB C Driver](https://github.com/mongodb/mongo-c-driver) ⭐ 861 | 🐛 8 | 🌐 C | 📅 2026-02-04 - MongoDB client library for C. \[Apache2]
* [Reindexer](https://github.com/Restream/reindexer) ⭐ 799 | 🐛 19 | 🌐 C++ | 📅 2026-02-09 - Embeddable, in-memory, document-oriented database with a high-level Query builder interface. \[Apache2] [website](https://reindexer.io/)
...
* [matplotplusplus](https://github.com/alandefreitas/matplotplusplus) ⭐ 4,802 | 🐛 75 | 🌐 C++ | 📅 2025-12-01 - C++ Graphics Library for Data Visualization. \[MIT] [website](https://alandefreitas.github.io/matplotplusplus/)
...
* [mathplot](https://github.com/sebsjames/mathplot) ⭐ 45 | 🐛 32 | 🌐 C++ | 📅 2026-02-06 - C++ header-only graphing and data visualization with modern OpenGL. \[Apache-2.0] [website](https://sebsjames.github.io/mathplot/)
...
* [Google Mock](https://github.com/google/googletest/blob/master/googlemock/README.md) ⭐ 38,203 | 🐛 516 | 🌐 C++ | 📅 2026-02-05 - A library for writing and using C++ mock classes. \[BSD]
* [Google Test](https://github.com/google/googletest) ⭐ 38,203 | 🐛 516 | 🌐 C++ | 📅 2026-02-05 - Google C++ Testing Framework. \[BSD]
* [Catch2](https://github.com/catchorg/Catch2) ⭐ 20,178 | 🐛 419 | 🌐 C++ | 📅 2026-01-19 - A modern, C++-native, test framework for unit-tests, TDD and BDD. \[Boost]
* [benchmark](https://github.com/google/benchmark) ⭐ 9,999 | 🐛 183 | 🌐 C++ | 📅 2026-02-06 - Google provided small microbenchmark support library. \[Apache2]
* [doctest](https://github.com/onqtam/doctest) ⭐ 6,609 | 🐛 167 | 🌐 C++ | 📅 2026-02-07 - The lightest feature rich C++ single header testing framework. \[MIT]
* [Unity](https://github.com/ThrowTheSwitch/Unity) ⭐ 5,043 | 🐛 112 | 🌐 C | 📅 2026-01-23 - Simple Unit Testing for C. \[MIT]
* [backward-cpp](https://github.com/bombela/backward-cpp) ⭐ 4,239 | 🐛 122 | 🌐 C++ | 📅 2025-04-14 - A beautiful stack trace pretty printer for C++. \[MIT]
* [Remotery](https://github.com/Celtoys/Remotery) ⭐ 3,284 | 🐛 38 | 🌐 C | 📅 2024-08-28 - Single C File Profiler with Web Viewer. \[Apache2]
* [dbg-macro](https://github.com/sharkdp/dbg-macro) ⭐ 3,228 | 🐛 13 | 🌐 C++ | 📅 2025-03-01 - A dbg(…) macro for C++. \[MIT]
...
* [Cpptrace](https://github.com/jeremy-rifkin/cpptrace) ⭐ 1,335 | 🐛 18 | 🌐 C++ | 📅 2026-02-07 - A simple, portable, and self-contained C++ stacktrace library supporting C++11 and greater. \[MIT]
...
* [Boost.Test](https://github.com/boostorg/test) ⭐ 210 | 🐛 96 | 🌐 C++ | 📅 2026-01-29 - Boost Test Library. \[Boost] [website](https://boost.org/libs/test)
...
* [Sphinx](https://github.com/sphinx-doc/sphinx) ⭐ 7,659 | 🐛 1,385 | 🌐 Python | 📅 2026-02-08 - Sphinx makes it easy to create intelligent and beautiful documentation. \[BSD-2-Clause] [website](https://www.sphinx-doc.org)
* [doxygen](https://github.com/doxygen/doxygen) ⭐ 6,335 | 🐛 1,889 | 🌐 C++ | 📅 2026-02-08 :zap: - The de facto standard tool for generating documentation from annotated C++ sources. \[GPL2] [website](https://www.doxygen.org)
...
* [harfbuzz](https://github.com/harfbuzz/harfbuzz) ⭐ 5,345 | 🐛 88 | 🌐 C++ | 📅 2026-02-09 - A text shaping engine. \[Old MIT]
...
* [Godot](https://github.com/godotengine/godot) ⭐ 106,471 | 🐛 17,524 | 🌐 C++ | 📅 2026-02-06 - A fully featured, open source, MIT licensed, game engine. \[MIT]
* [raylib](https://github.com/raysan5/raylib) ⭐ 30,842 | 🐛 11 | 🌐 C | 📅 2026-02-06 - A simple and easy-to-use library to enjoy videogames programming. \[zlib/libpng] [website](http://www.raylib.com/)
* [Hazel Game Engine](https://github.com/TheCherno/Hazel) ⭐ 12,848 | 🐛 137 | 🌐 C++ | 📅 2024-04-20 - Hazel is primarily an early-stage interactive application and rendering engine for Windows. \[Apache-2.0 license]
* [EnTT](https://github.com/skypjack/entt) ⭐ 12,254 | 🐛 20 | 🌐 C++ | 📅 2026-02-06 - Gaming meets modern C++. \[MIT]
* [o3de](https://github.com/o3de/o3de) ⭐ 8,935 | 🐛 3,503 | 🌐 C++ | 📅 2026-02-07 - An open-source, real-time, multi-platform 3D engine based on Amazon Lumberyard. \[Apache2] [website](https://o3de.org/)
...
* [GamePlay](https://github.com/gameplay3d/GamePlay) ⭐ 4,795 | 🐛 10 | 🌐 C++ | 📅 2025-02-25 - A cross-platform native C++ game framework for creating 2D/3D mobile and desktop games. \[Apache2]
...
* [Halley](https://github.com/amzeratul/halley) ⭐ 3,797 | 🐛 45 | 🌐 C++ | 📅 2026-02-07 - A lightweight game engine written in C++14 with a "true" entity-component system. \[Apache 2.0]
* [OpenXRay](https://github.com/OpenXRay/xray-16) ⭐ 3,434 | 🐛 257 | 🌐 C++ | 📅 2026-02-08 - a community-modified X-Ray engine used in S.T.A.L.K.E.R. game series. \[Modified BSD/non-commercial only]
...
* [ezEngine](https://github.com/ezEngine/ezEngine) ⭐ 1,893 | 🐛 32 | 🌐 C++ | 📅 2026-02-08 - Is a free, open-source game engine written in C++. Its philosophy is to be modular and flexible, such that it can be adapted to many different use cases. \[MIT] [website](https://ezengine.net/)
* [toy engine](https://github.com/hugoam/toy) ⭐ 1,587 | 🐛 13 | 🌐 C++ | 📅 2021-04-25 - toy is a thin and modular c++ game engine and offers simple expressive c++ idioms to design full featured 2D or 3D games in fast iterations.
...
* [Axmol Engine](https://github.com/axmolengine/axmol) ⭐ 1,303 | 🐛 8 | 🌐 C++ | 📅 2026-02-05 - A cross-platform game engine for desktop, mobile, and XBOX (UWP), derived from Cocos2d-x-4.0. \[MIT] [website](https://axmol.dev/)
* [nCine](https://github.com/nCine/nCine) ⭐ 1,278 | 🐛 1 | 🌐 C++ | 📅 2026-01-27 - A cross-platform 2D game engine with an emphasis on performance, written in C++11 and optionally scriptable in Lua. \[MIT] [website](https://ncine.github.io/)
* [IX-Ray Platform](https://github.com/ixray-team/ixray-1.6-stcop) ⭐ 327 | 🐛 60 | 🌐 C++ | 📅 2026-02-09 - Fork of X-Ray 1.6 engine that aims to improve gaming experience and simplify development of modifications. \[Modified MIT/non-commercial only]
...
* [crown](https://github.com/dbartolini/crown) ⭐ 27 | 🐛 0 | 🌐 C++ | 📅 2026-02-08 - Crown is a general purpose data-driven game engine, written from scratch in orthodox C++ with a minimalistic and data-oriented design philosophy in mind. \[MIT]
...
* [imgui](https://github.com/ocornut/imgui) ⭐ 71,229 | 🐛 1,207 | 🌐 C++ | 📅 2026-02-05 - Immediate Mode Graphical User Interface with minimal dependencies. \[MIT]
* [Slint](https://github.com/slint-ui/slint) ⭐ 21,700 | 🐛 827 | 🌐 Rust | 📅 2026-02-09 - Lightweight GUI toolkit for desktop and embedded. \[GPL/Free/Proprietary] [website](https://slint.dev/)
...
* [WebUI](https://github.com/webui-dev/webui) ⭐ 4,014 | 🐛 18 | 🌐 C | 📅 2026-02-05 - Use any web browser as GUI, with your preferred language in the backend and HTML5 in the frontend. \[MIT] [website](https://webui.me/)
...
* [Elements](https://github.com/cycfi/elements) ⭐ 3,659 | 🐛 45 | 🌐 C++ | 📅 2025-11-23 - Lightweight, fine-grained, resolution independent, modular GUI library. \[MIT]
* [Yue](https://github.com/yue/yue) ⭐ 3,603 | 🐛 13 | 🌐 C++ | 📅 2025-01-24 - A library for creating native cross-platform GUI apps. \[LGPLv2]
* [GacUI](https://github.com/vczh-libraries/GacUI) ⭐ 2,488 | 🐛 12 | 🌐 C++ | 📅 2026-02-08 - GPU Accelerated C++ User Interface, with WYSIWYG developing tools, XML supports, built-in data binding and MVVM features. \[Ms-PL]
...
* [TGUI](https://github.com/texus/TGUI) ⭐ 1,012 | 🐛 9 | 🌐 C++ | 📅 2026-02-08 - Cross-platform modern c++ GUI. \[Zlib] [website](https://tgui.eu/)
* [MyGUI](https://github.com/MyGUI/mygui) ⭐ 806 | 🐛 24 | 🌐 C++ | 📅 2025-08-02 - Fast, flexible and simple GUI. \[MIT]
* [Saucer](https://github.com/saucer/saucer) ⭐ 784 | 🐛 4 | 🌐 C++ | 📅 2026-02-08 - A modern, cross-platform C++ webview library. \[MIT]
...
* [bgfx](https://github.com/bkaradzic/bgfx) ⭐ 16,697 | 🐛 315 | 🌐 C++ | 📅 2026-02-09 - A cross-platform rendering library. \[BSD]
* [GLFW](https://github.com/glfw/glfw) ⭐ 14,672 | 🐛 737 | 🌐 C | 📅 2026-02-05 - A simple, cross-platform OpenGL wrangling library. \[zlib/libpng]
...
* [Skia](https://github.com/google/skia) ⭐ 10,474 | 🐛 46 | 🌐 C++ | 📅 2026-02-09 - A complete 2D graphic library for drawing Text, Geometries, and Images. \[BSD] [website](https://skia.org/)
...
* [Diligent Engine](https://github.com/DiligentGraphics/DiligentEngine) ⭐ 4,168 | 🐛 21 | 🌐 Batchfile | 📅 2026-02-08 - A modern cross-platform low-level 3D graphics library. \[Apache2]
...
* [DirectXTK](https://github.com/Microsoft/DirectXTK) ⭐ 2,779 | 🐛 33 | 🌐 C++ | 📅 2026-02-03 - A collection of helper classes for writing DirectX 11.x code in C++. \[MIT]
...
* [ThorVG](https://github.com/thorvg/thorvg) ⭐ 1,431 | 🐛 172 | 🌐 C++ | 📅 2026-02-08 - a platform-independent portable library that allows for drawing vector-based scenes and animations, including SVG and Lottie. \[MIT] [website](https://www.thorvg.org/)
...
* [stb-image](https://github.com/nothings/stb/blob/master/stb_image.h) ⭐ 32,426 | 🐛 371 | 🌐 C | 📅 2025-10-25 - STB single-header image loading library. \[Public Domain]
* [Dlib](https://github.com/davisking/dlib) ⭐ 14,326 | 🐛 43 | 🌐 C++ | 📅 2026-02-05 :zap: - A modern C++11 machine learning, computer vision, numerical optimization, and deep learning toolkit. \[Boost] [website](http://dlib.net/)
...
* [libjpeg-turbo](https://github.com/libjpeg-turbo/libjpeg-turbo) ⭐ 4,211 | 🐛 19 | 🌐 C | 📅 2026-02-05 - A JPEG image codec that uses SIMD instructions to accelerate baseline JPEG encoding and decoding. \[IJG & BSD-3-Clause & zlib] [website](https://libjpeg-turbo.org/)
* [libjxl](https://github.com/libjxl/libjxl) ⭐ 3,353 | 🐛 417 | 🌐 C++ | 📅 2026-02-09 - JPEG XL image format reference implementation. \[BSD-3-Clause]
* [LodePNG](https://github.com/lvandeve/lodepng) ⭐ 2,289 | 🐛 94 | 🌐 C++ | 📅 2026-02-02 - PNG encoder and decoder in C and C++. \[Zlib]
...
* [Leptonica](https://github.com/DanBloomberg/leptonica) ⭐ 2,022 | 🐛 70 | 🌐 C | 📅 2026-02-04 - Leptonica is an open source library containing software that is broadly useful for image processing and image analysis applications. \[BSD-2-Clause] [website](http://leptonica.org/index.html)
* [libavif](https://github.com/AOMediaCodec/libavif) ⭐ 2,000 | 🐛 160 | 🌐 C | 📅 2026-02-08 - Library for encoding and decoding .avif files. \[BSD-2-Clause]
...
* [simdutf](https://github.com/simdutf/simdutf) ⭐ 1,674 | 🐛 73 | 🌐 C++ | 📅 2026-02-06 - Unicode routines (UTF8, UTF16, UTF32): billions of characters per second using SSE2, AVX2, NEON, AVX-512. \[Apache-2/MIT]
...
* [gRPC](https://github.com/grpc/grpc) ⭐ 44,327 | 🐛 1,171 | 🌐 C++ | 📅 2026-02-07 - A high performance, open source, general-purpose RPC framework. \[BSD] [website](http://www.grpc.io/)
...
* [Cap'n Proto](https://github.com/capnproto/capnproto) ⭐ 12,844 | 🐛 296 | 🌐 C++ | 📅 2026-02-08 - Fast data interchange format and capability-based RPC system. \[MIT] [website](https://capnproto.org/)
* [nanomsg](https://github.com/nanomsg/nanomsg) ⭐ 6,252 | 🐛 2 | 🌐 C | 📅 2025-10-05 - A simple high-performance implementation of several "scalability protocols". \[MIT] [website](http://nanomsg.org/)
...
* [Ice](https://github.com/zeroc-ice/ice) ⭐ 2,160 | 🐛 79 | 🌐 C++ | 📅 2026-02-07 - Comprehensive RPC framework with support for C++, C#, Java, JavaScript, Python and more. \[GPLv2]
...
* [json](https://github.com/nlohmann/json) ⭐ 48,811 | 🐛 100 | 🌐 C++ | 📅 2026-02-07 :zap: - JSON for Modern C++. \[MIT] [website](https://json.nlohmann.me)
* [simdjson](https://github.com/lemire/simdjson) ⭐ 23,216 | 🐛 138 | 🌐 C++ | 📅 2026-02-09 - Extremely fast JSON library that can parse gigabytes of JSON per second. \[Apache-2.0]
...
* [cJSON](https://github.com/DaveGamble/cJSON) ⭐ 12,436 | 🐛 294 | 🌐 C | 📅 2026-02-07 - Ultralightweight JSON parser in ANSI C. \[MIT]
...
* [Jsmn](https://github.com/zserge/jsmn) ⭐ 4,057 | 🐛 97 | 🌐 C | 📅 2024-06-09 - A minimalistic JSON parser in C. \[MIT]
* [yyjson](https://github.com/ibireme/yyjson) ⭐ 3,615 | 🐛 25 | 🌐 C | 📅 2026-01-19 - A high performance JSON library written in ANSI C. \[MIT]
* [Jansson](https://github.com/akheron/jansson) ⭐ 3,307 | 🐛 124 | 🌐 C | 📅 2026-02-01 - C library for encoding, decoding and manipulating JSON data. \[MIT]
* [json-c](https://github.com/json-c/json-c) ⭐ 3,238 | 🐛 21 | 🌐 C | 📅 2026-02-08 - A JSON implementation in C. \[MIT]
* [json11](https://github.com/dropbox/json11) ⚠️ Archived - A tiny JSON library for C++11. \[MIT]
* [Glaze](https://github.com/stephenberry/glaze) ⭐ 2,374 | 🐛 33 | 🌐 C++ | 📅 2026-02-06 - Extremely fast, in memory, JSON and interface library for modern C++. \[MIT]
...
* [Sonic-Cpp](https://github.com/bytedance/sonic-cpp) ⭐ 968 | 🐛 31 | 🌐 C++ | 📅 2026-02-06 - A fast JSON serializing & deserializing library, accelerated by SIMD. \[Apache-2.0]
...
* [JSON Toolkit](https://github.com/sourcemeta/jsontoolkit) ⭐ 47 | 🐛 17 | 🌐 C++ | 📅 2026-02-06 - JSON, JSON Pointer, JSON Schema, and JSONL library for C++20. \[AGPL/Commercial]
...
* [spdlog](https://github.com/gabime/spdlog) ⭐ 28,295 | 🐛 57 | 🌐 C++ | 📅 2026-01-15 - Super fast, header only, C++ logging library.
...
* [BqLog](https://github.com/Tencent/BqLog) ⭐ 503 | 🐛 0 | 🌐 C++ | 📅 2026-02-09 -  A lightweight, high-performance logging system used in projects such as "Honor of Kings". \[Apache-2.0]
...
* [OpenCV](https://github.com/Itseez/opencv) ⭐ 86,107 | 🐛 2,736 | 🌐 C++ | 📅 2026-02-07 :zap: - Open Source Computer Vision Library. \[BSD] [website](http://opencv.org/)
* [FAISS](https://github.com/facebookresearch/faiss) ⭐ 39,037 | 🐛 281 | 🌐 C++ | 📅 2026-02-06 - A library for efficient similarity search and clustering of dense vectors. \[MIT]
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,832 | 🐛 1,176 | 🌐 C++ | 📅 2024-07-31 - A fast framework for neural networks. \[BSD]
* [xgboost](https://github.com/dmlc/xgboost) ⭐ 27,984 | 🐛 473 | 🌐 C++ | 📅 2026-02-07 - Scalable, Portable and Distributed Gradient Boosting (GBDT, GBRT or GBM) Library, for Python, R, Java, Scala, C++ and more. Runs on single machine, Hadoop, Spark, Flink and DataFlow. \[Apache2]
...
* [ncnn](https://github.com/Tencent/ncnn) ⭐ 22,764 | 🐛 1,156 | 🌐 C++ | 📅 2026-02-09 - A high-performance neural network inference computing framework optimized for mobile platforms. \[BSD]
* [ONNX runtime](https://github.com/microsoft/onnxruntime) ⭐ 19,238 | 🐛 1,269 | 🌐 C++ | 📅 2026-02-09 - C and C++ library for training and inference ONNX models. ONNX is a standard that AI models can be converted into, regardless of the library they are trained with. \[MIT] [website](https://onnxruntime.ai/)
* [Dlib](https://github.com/davisking/dlib) ⭐ 14,326 | 🐛 43 | 🌐 C++ | 📅 2026-02-05 :zap: - A modern C++11 machine learning, computer vision, numerical optimization, and deep learning toolkit. \[Boost] [website](http://dlib.net/)
* [ggml](https://github.com/ggerganov/ggml) ⭐ 13,926 | 🐛 322 | 🌐 C++ | 📅 2026-02-07 - Tensor library for machine learning with 16-bit and 4-bit quantization support. \[MIT]
* [catboost](https://github.com/catboost/catboost) ⭐ 8,792 | 🐛 674 | 🌐 C++ | 📅 2026-02-09 - A fast, scalable, high performance Gradient Boosting on Decision Trees library. \[Apache2]
...
* [MeTA](https://github.com/meta-toolkit/meta) ⭐ 712 | 🐛 56 | 🌐 C++ | 📅 2023-04-17 - A modern C++ data sciences toolkit. \[MIT] [website](https://meta-toolkit.org/)
* [Minerva](https://github.com/dmlc/minerva) ⚠️ Archived - A fast and flexible system for deep learning. \[Apache2]
* [oneDAL](https://github.com/oneapi-src/oneDAL) ⭐ 647 | 🐛 64 | 🌐 C++ | 📅 2026-02-04 - A powerful machine learning library that helps speed up big data analysis. \[Apache]
...
* [Dlib](https://github.com/davisking/dlib) ⭐ 14,326 | 🐛 43 | 🌐 C++ | 📅 2026-02-05 :zap: - A modern C++11 machine learning, computer vision, numerical optimization, and deep learning toolkit. \[Boost] [website](http://dlib.net/)
* [GLM](https://github.com/g-truc/glm) ⭐ 10,683 | 🐛 108 | 🌐 C++ | 📅 2026-01-12 - Header-only C++ math library that matches and inter-operates with OpenGL's GLSL math. \[MIT] [website](https://glm.g-truc.net/)
* [OpenBLAS](https://github.com/xianyi/OpenBLAS) ⭐ 7,268 | 🐛 123 | 🌐 C | 📅 2026-02-08 - An optimized BLAS library based on GotoBLAS2 1.13 BSD version. \[BSD 3-clause] [website](http://www.openblas.net/)
* [QuantLib](https://github.com/lballabio/quantlib) ⭐ 6,746 | 🐛 64 | 🌐 C++ | 📅 2026-02-02 - A free/open-source library for quantitative finance. \[Modified BSD] [website](http://quantlib.org/)
...
* [xtensor](https://github.com/xtensor-stack/xtensor) ⭐ 3,703 | 🐛 436 | 🌐 C++ | 📅 2026-01-29 - A C++14 library for numerical analysis with multi-dimensional array expressions, inspired by NumPy syntax. \[BSD 3-clause] [website](https://xtensor-stack.github.io/xtensor)
...
* [DirectXMath](https://github.com/microsoft/DirectXMath) ⭐ 1,747 | 🐛 20 | 🌐 C++ | 📅 2026-02-03 - An all inline SIMD C++ linear algebra library for use in games and graphics apps.
...
* [universal](https://github.com/stillwater-sc/universal) ⭐ 485 | 🐛 37 | 🌐 C++ | 📅 2026-02-09 - A C++14 header-only library implementing arbitrary posit arithmetic. The posit number system is a tapered floating point that is more efficient than IEEE floating point. Posits enable reproducible computational science. \[MIT license]
...
* [OMath](https://github.com/orange-cpp/omath) ⭐ 173 | 🐛 3 | 🌐 C++ | 📅 2026-02-08 - Cross-platform modern general purpose math library written in C++23 that suitable for cheat/game development. \[ZLIB]
* [cml](https://github.com/demianmnave/CML) ⭐ 84 | 🐛 11 | 🌐 C++ | 📅 2025-12-15 - The configurable math library. \[Boost]
* [sebsjames/maths](https://github.com/sebsjames/maths) ⭐ 7 | 🐛 13 | 🌐 C++ | 📅 2026-02-08 - A templated C++20 math library which emphasizes convenience and pleasure for the client programmer (used in [mathplot](https://github.com/sebsjames/mathplot) ⭐ 45 | 🐛 32 | 🌐 C++ | 📅 2026-02-06).  \[Apache2] [website](https://sebsjames.github.io/maths/)
...
* [mimalloc](https://github.com/microsoft/mimalloc) ⭐ 12,450 | 🐛 422 | 🌐 C | 📅 2026-02-06 - A compact general purpose allocator with excellent performance. \[MIT]
...
* [TCMalloc](https://github.com/google/tcmalloc) ⭐ 5,118 | 🐛 59 | 🌐 C++ | 📅 2026-02-06 - Google's fast, multi-threaded malloc implementation. \[Apache-2.0] [website](https://google.github.io/tcmalloc/)
* [Boehm GC](https://github.com/ivmai/bdwgc) ⭐ 3,417 | 🐛 182 | 🌐 C | 📅 2026-02-05 - Conservative garbage collector for C and C++. \[similar to X11] [website](http://www.hboehm.info/gc/)
...
* [memory-allocators](https://github.com/mtrebi/memory-allocators) ⭐ 1,924 | 🐛 16 | 🌐 C++ | 📅 2024-05-23 - Custom memory allocators to improve the performance of dynamic memory allocation. \[MIT]
...
* [SDL](https://github.com/libsdl-org/SDL) ⭐ 14,830 | 🐛 806 | 🌐 C | 📅 2026-02-09 :zap: - Simple DirectMedia Layer. \[zlib] [website](https://libsdl.org)
* [SFML](https://github.com/SFML/SFML) ⭐ 11,645 | 🐛 154 | 🌐 C++ | 📅 2026-02-09 :zap: - Simple and Fast Multimedia Library. \[zlib] [website](http://www.sfml-dev.org/)
...
* [MediaInfoLib](https://github.com/MediaArea/MediaInfoLib) ⭐ 743 | 🐛 326 | 🌐 C++ | 📅 2026-02-08 - Convenient unified display of the most relevant technical and tag data for video and audio files. \[BSD]
...
* [uWebSockets](https://github.com/uNetworking/uWebSockets) ⭐ 18,688 | 🐛 46 | 🌐 C++ | 📅 2026-01-15 - µWS is one of the most lightweight, efficient & scalable WebSocket & HTTP server implementations available. \[Zlib]
* [KCP](https://github.com/skywind3000/kcp/blob/master/README.en.md) ⭐ 16,589 | 🐛 193 | 🌐 C | 📅 2025-04-22 - A fast and reliable ARQ protocol that helps applications to reduce network latency. \[MIT]
* [cpp-httplib](https://github.com/yhirose/cpp-httplib) ⭐ 16,107 | 🐛 2 | 🌐 C++ | 📅 2026-02-09 - A single file C++11 header-only HTTP/HTTPS server library. \[MIT]
* [Muduo](https://github.com/chenshuo/muduo) ⭐ 15,939 | 🐛 82 | 🌐 C++ | 📅 2025-12-23 - A C++ non-blocking network library for multi-threaded server in Linux. \[BSD]
* [Mongoose](https://github.com/cesanta/mongoose) ⭐ 12,512 | 🐛 5 | 🌐 C | 📅 2026-02-06 - Extremely lightweight webserver. \[GPL2]
* [RedPanda](https://github.com/redpanda-data/redpanda) ⭐ 11,691 | 🐛 658 | 🌐 C++ | 📅 2026-02-08 - Streaming data platform for developers. Kafka API compatible. 10x faster. \[BSL]
* [H2O](https://github.com/h2o/h2o) ⭐ 11,389 | 🐛 723 | 🌐 C | 📅 2026-02-06 - An optimized HTTP server with support for HTTP/1.x and HTTP/2. It can also be used as a library. \[MIT]
...
* [Proxygen](https://github.com/facebook/proxygen) ⭐ 8,328 | 🐛 37 | 🌐 C++ | 📅 2026-02-07 - Facebook's collection of C++ HTTP libraries including an easy to use HTTP server. \[BSD]
* [C++ REST SDK](https://github.com/Microsoft/cpprestsdk) ⭐ 8,259 | 🐛 885 | 🌐 C++ | 📅 2025-06-12 - C++ REST SDK (previously named Casablanca). \[Apache2]
* [WebSocket++](https://github.com/zaphoyd/websocketpp) ⭐ 7,632 | 🐛 479 | 🌐 C++ | 📅 2025-04-19 - C++/Boost Asio based websocket client/server library. \[BSD]
...
* [libwebsockets](https://github.com/warmcat/libwebsockets) ⭐ 5,184 | 🐛 207 | 🌐 C | 📅 2026-02-05 - A lightweight pure C WebSocket implementation that provides both client and server libraries. \[LGPL2.1 + static link exception] [website](https://libwebsockets.org/)
* [nghttp2](https://github.com/nghttp2/nghttp2) ⭐ 4,948 | 🐛 43 | 🌐 C++ | 📅 2026-01-27 - HTTP/2 C Library. \[MIT] [website](https://nghttp2.org/)
* [Boost.Beast](https://github.com/boostorg/beast) ⭐ 4,749 | 🐛 111 | 🌐 C++ | 📅 2026-01-28 :zap: - HTTP and WebSocket built on Boost.Asio in C++11. \[Boost] [website](https://www.boost.org/libs/beast)
* [DPDK](https://github.com/DPDK/dpdk) ⭐ 4,092 | 🐛 23 | 🌐 C | 📅 2026-02-08 - Data Plane Development Kit, libraries and drivers for fast packet processing. \[BSD-3-Clause & GPL-2.0] [website](https://www.dpdk.org/)
...
* [ada](https://github.com/ada-url/ada) ⭐ 1,688 | 🐛 25 | 🌐 C++ | 📅 2026-02-06 - WHATWG-compliant and fast URL parser written in modern C++. \[Apache-2.0/MIT]
...
* [librdkafka](https://github.com/edenhill/librdkafka) ⭐ 907 | 🐛 544 | 🌐 C | 📅 2026-02-06 - Apache Kafka client library for C and C++. \[BSD-2-Clause]
...
* [uriparser](https://github.com/uriparser/uriparser) ⭐ 399 | 🐛 5 | 🌐 C | 📅 2026-01-26 - Strictly RFC 3986 compliant URI parsing and handling library. \[BSD-3-Clause]
...
* [QPDF](https://github.com/qpdf/qpdf) ⭐ 4,746 | 🐛 158 | 🌐 C++ | 📅 2026-02-07 - A tool and C++ library for content-preserving transformations of PDF files. \[Apache-2.0] [website](https://qpdf.sourceforge.io/)
...
* [Jolt Physics](https://github.com/jrouwe/JoltPhysics) ⭐ 9,588 | 🐛 8 | 🌐 C++ | 📅 2026-02-07 - A multi core friendly rigid body physics and collision detection library. \[MIT]
* [Box2D](https://github.com/erincatto/Box2D) ⭐ 9,486 | 🐛 24 | 🌐 C | 📅 2026-01-02 - A 2D physics engine for games. \[BSD-like]
* [LiquidFun](https://github.com/google/liquidfun) ⭐ 4,892 | 🐛 69 | 🌐 C++ | 📅 2023-04-26 - A 2D physics engine for games. \[BSD-like]
* [Project Chrono](https://github.com/projectchrono/chrono) ⭐ 2,715 | 🐛 71 | 🌐 C++ | 📅 2026-02-08 - An open source multi-physics simulation engine. \[BSD-3-Clause] [website](https://projectchrono.org/)
...
* [Kratos](https://github.com/KratosMultiphysics/Kratos) ⭐ 1,220 | 🐛 657 | 🌐 C++ | 📅 2026-02-07 - framework for building parallel, multi-disciplinary simulation software, aiming at modularity, extensibility, and high performance. \[BSD] [website](http://www.cimne.com/kratos/)
* [SOFA](https://github.com/sofa-framework/sofa) ⭐ 1,150 | 🐛 445 | 🌐 C++ | 📅 2026-02-09 - SOFA is an open-source framework targeting at real-time simulation, with an emphasis on medical simulation. \[LGPL] [website](https://www.sofa-framework.org)
...
* [Magic Enum](https://github.com/Neargye/magic_enum) ⭐ 5,942 | 🐛 19 | 🌐 C++ | 📅 2026-02-07 - Header-only C++17 library provides static reflection for enums (to string, from string, iteration), work with any enum type without any macro or boilerplate code. \[MIT]
...
* [reflect-cpp](https://github.com/getml/reflect-cpp) ⭐ 1,737 | 🐛 53 | 🌐 C++ | 📅 2026-02-08 - Serialization through reflection, including automatic field name retrieval from structs. \[MIT]
...
* [RE2](https://github.com/google/re2) ⭐ 9,592 | 🐛 12 | 🌐 C++ | 📅 2026-01-22 - A software library for regular expressions via a finite-state machine using automata theory. \[BSD-3-Clause]
...
* [PCL](https://github.com/PointCloudLibrary/pcl) ⭐ 10,859 | 🐛 593 | 🌐 C++ | 📅 2026-02-05 - Point Cloud Library is a standalone, large scale, open project for 2D/3D image and point cloud processing. \[BSD] [website](http://www.pointclouds.org/)
...
* [pybind11](https://github.com/pybind/pybind11) ⭐ 17,705 | 🐛 722 | 🌐 C++ | 📅 2026-02-08 - Seamless operability between C++11 and Python. \[BSD]
* [Cython](https://github.com/cython/cython) ⭐ 10,606 | 🐛 1,507 | 🌐 Cython | 📅 2026-02-08 - Cython is an optimising static compiler for both the Python programming language and the extended Cython programming language (based on Pyrex). It makes writing C extensions for Python as easy as Python itself. \[Apache] [website](http://cython.org/)
...
* [SWIG](https://github.com/swig/swig) ⭐ 6,233 | 🐛 475 | 🌐 SWIG | 📅 2026-02-07 - A wrapper/interface Generator that let you link your c++ code to JavaScript, Perl, PHP, Python, Tcl and Ruby. \[GPL/Output not licensed] [website](http://www.swig.org/)
* [Duktape](https://github.com/svaarala/duktape) ⭐ 6,171 | 🐛 474 | 🌐 JavaScript | 📅 2024-03-22 - An embeddable JavaScript engine with compact footprint. \[MIT] [website](http://duktape.org)
* [MicroQuickJS](https://github.com/bellard/mquickjs) ⭐ 5,473 | 🐛 14 | 🌐 C | 📅 2026-01-15 - MicroQuickJS (aka. MQuickJS) is a JavaScript engine targeted at embedded systems. \[MIT]
* [Luau](https://github.com/luau-lang/luau) ⭐ 5,257 | 🐛 352 | 🌐 C++ | 📅 2026-02-06 - A fast, small, safe, gradually typed embeddable scripting language derived from Lua. \[MIT] [website](https://luau.org/)
* [sol2](https://github.com/ThePhD/sol2) ⭐ 4,911 | 🐛 305 | 🌐 C++ | 📅 2025-03-07 - A C++ <-> Lua API wrapper with advanced features and top notch performance. \[MIT]
* [JavaCpp](https://github.com/bytedeco/javacpp) ⭐ 4,686 | 🐛 110 | 🌐 Java | 📅 2025-12-09 - The missing bridge between Java and native C++. \[Apache2]
* [libffi](https://github.com/libffi/libffi) ⭐ 4,168 | 🐛 203 | 🌐 C | 📅 2025-12-26 - A portable foreign-function interface library. \[MIT] [website](https://sourceware.org/libffi/)
...
* [nanobind](https://github.com/wjakob/nanobind) ⭐ 3,335 | 🐛 36 | 🌐 C++ | 📅 2026-02-03 - tiny and efficient C++/Python bindings. \[BSD-3-Clause]
...
* [txiki.js](https://github.com/saghul/txiki.js) ⭐ 2,888 | 🐛 30 | 🌐 C | 📅 2026-02-08 - A tiny JavaScript runtime. \[MIT]
* [ctypes.sh](https://github.com/taviso/ctypes.sh) ⭐ 2,158 | 🐛 21 | 🌐 C | 📅 2025-12-22 - A foreign function interface for bash. \[MIT]
* [pocketpy](https://github.com/blueloveTH/pocketpy) ⭐ 2,014 | 🐛 11 | 🌐 C | 📅 2026-02-08 - C++17 header-only Python interpreter for game scripting. \[MIT] [website](https://pocketpy.dev/)
...
* [LuaBridge](https://github.com/vinniefalco/LuaBridge) ⭐ 1,749 | 🐛 48 | 🌐 C | 📅 2025-10-13 - A lightweight, dependency-free library for binding Lua to C++. \[MIT]
...
* [protobuf](https://github.com/protocolbuffers/protobuf) ⭐ 70,663 | 🐛 226 | 🌐 C++ | 📅 2026-02-09 - Protocol Buffers - Google's data interchange format. \[BSD]
* [FlatBuffers](https://github.com/google/flatbuffers) ⭐ 25,529 | 🐛 144 | 🌐 C++ | 📅 2026-02-07 - A Memory efficient serialization library. \[Apache2]
* [Cap'n Proto](https://github.com/capnproto/capnproto) ⭐ 12,844 | 🐛 296 | 🌐 C++ | 📅 2026-02-08 - Fast data interchange format and capability-based RPC system. \[MIT] [website](https://capnproto.org/)
* [nanopb](https://github.com/nanopb/nanopb) ⭐ 5,199 | 🐛 79 | 🌐 C | 📅 2026-02-08 - Small code-size Protocol Buffers implementation in ANSI C. \[Zlib]
...
* [cista](https://github.com/felixguendling/cista) ⭐ 2,169 | 🐛 8 | 🌐 C++ | 📅 2025-12-13 - A C++17 library for zero-copy high-performance (de-)serialization. \[MIT]
* [mrpt-serialization](https://github.com/mrpt/mrpt/) ⭐ 2,110 | 🐛 28 | 🌐 C++ | 📅 2026-02-08 - Versioned serialization to binary or text formats. \[BSD] [website](https://docs.mrpt.org/reference/latest/group_mrpt_serialization_grp.html)
...
* [Wirehair](https://github.com/catid/wirehair) ⭐ 289 | 🐛 8 | 🌐 C++ | 📅 2023-12-02 - O(N) Fountain Code for Large Data. \[BSD-3-Clause]
...
* [Asio](https://github.com/chriskohlhoff/asio/) ⭐ 5,742 | 🐛 1,050 | 🌐 C++ | 📅 2025-11-30 - Asio includes classes for creating and manipulating serial ports in a portable manner. \[Boost] [website](http://think-async.com/)
...
- [pdqsort](https://github.com/orlp/pdqsort) ⭐ 2,470 | 🐛 5 | 🌐 C++ | 📅 2023-12-06 - Pattern-defeating quicksort. \[zlib]
...
* [OpenH264](https://github.com/cisco/openh264) ⭐ 6,074 | 🐛 287 | 🌐 C++ | 📅 2025-10-28 - Open Source H.264 Codec. \[BSD] [website](http://www.openh264.org/)
...
* [MicroPython](https://github.com/micropython/micropython) ⭐ 21,446 | 🐛 1,840 | 🌐 C | 📅 2026-02-07 - Aims to put an implementation of Python 3.x on a microcontroller. \[MIT]
...
* [Drogon](https://github.com/an-tao/drogon) ⭐ 13,512 | 🐛 388 | 🌐 C++ | 📅 2026-01-26 - A C++17/20 based, high-performance HTTP application framework. \[MIT]
* [oat++](https://github.com/oatpp/oatpp) ⭐ 8,545 | 🐛 331 | 🌐 C++ | 📅 2025-11-12 - Light, zero-dependency framework to create high-performance web-services. \[Apache-2.0] [website](https://oatpp.io/)
...
* [Crow](https://github.com/CrowCpp/Crow) ⭐ 4,708 | 🐛 84 | 🌐 C++ | 📅 2026-02-03 - Crow is a C++ microframework for running web services. It uses routing similar to Python's Flask. \[BSD] [website](https://crowcpp.org)
...
* [userver](https://github.com/userver-framework/userver) ⭐ 2,805 | 🐛 131 | 🌐 C++ | 📅 2026-02-07 - Asynchronous C++17 framework with a rich set of abstractions and database drivers for fast and comfortable creation of efficient microservices, services and utilities. \[Apache-2.0] [website](https://userver.tech/)
...
* [TinyXML2](https://github.com/leethomason/tinyxml2) ⭐ 5,710 | 🐛 134 | 🌐 C++ | 📅 2025-11-23 - A simple, small, efficient, C++ XML parser that can be easily integrating into other programs. \[zlib]
* [Mini-XML](https://github.com/michaelrsweet/mxml) ⭐ 504 | 🐛 7 | 🌐 C | 📅 2025-12-19 - A small XML parsing library written in ANSI C. \[LGPL2 with exceptions]
...
* [yaml-cpp](https://github.com/jbeder/yaml-cpp) ⭐ 5,829 | 🐛 367 | 🌐 C++ | 📅 2026-02-08 - A YAML parser and emitter in C++. \[MIT]
...
* [ZXing](https://github.com/zxing/zxing/) ⭐ 33,842 | 🐛 9 | 🌐 Java | 📅 2026-02-04 - An open-source, multi-format 1D/2D barcode image processing library implemented in Java, with ports to other languages. \[Apache]
* [stb](https://github.com/nothings/stb) ⭐ 32,426 | 🐛 371 | 🌐 C | 📅 2025-10-25 :zap: - A range of single-file libraries for C/C++. \[PublicDomain]
* [{fmt}](https://github.com/fmtlib/fmt) ⭐ 23,243 | 🐛 9 | 🌐 C++ | 📅 2026-02-08 :zap: - Small, safe and fast formatting library for C++. \[Simplified BSD] [website](https://fmt.dev)
* [xxHash](https://github.com/Cyan4973/xxHash) ⭐ 10,852 | 🐛 26 | 🌐 C | 📅 2026-01-26 - Extremely fast non-cryptographic hash algorithm. \[BSD-2-Clause] [website](https://xxhash.com/)
* [SDS](https://github.com/antirez/sds) ⭐ 5,374 | 🐛 105 | 🌐 C | 📅 2025-04-18 - Simple Dynamic Strings library for C. \[BSD]
* [Argon2](https://github.com/P-H-C/phc-winner-argon2) ⭐ 5,200 | 🐛 97 | 🌐 C | 📅 2024-08-06 - The password hash Argon2, winner of PHC. \[CC0/Apache2]
...
* [jwt-cpp](https://github.com/Thalhammer/jwt-cpp) ⭐ 1,108 | 🐛 43 | 🌐 C++ | 📅 2025-12-29 - A header only library for creating and validating JSON web tokens in C++. \[MIT]
...
* [fast\_io](https://github.com/cppfastio/fast_io) ⭐ 831 | 🐛 45 | 🌐 C++ | 📅 2026-01-19 - Significantly faster input/output for C++20. \[MIT]
...
* [Jinja2С++](https://github.com/jinja2cpp/Jinja2Cpp) ⭐ 571 | 🐛 53 | 🌐 C++ | 📅 2025-06-23 - almost full-conformance template engine implementation. [website](https://jinja2cpp.github.io/)
...
* [Boost.Signals2](https://github.com/boostorg/signals2) ⭐ 86 | 🐛 5 | 🌐 C++ | 📅 2026-02-06 - An implementation of a managed signals and slots system. \[Boost] [website](https://boost.org/libs/signals2)
...
* [Microsoft Visual Studio Code](https://github.com/microsoft/vscode) ⭐ 181,528 | 🐛 13,581 | 🌐 TypeScript | 📅 2026-02-09 :zap: - An open-source IDE from Microsoft. \[MIT] [website](https://code.visualstudio.com)
* [YouCompleteMe](https://github.com/ycm-core/YouCompleteMe) ⭐ 26,345 | 🐛 32 | 🌐 Python | 📅 2026-02-07 - YouCompleteMe is a fast, as-you-type, fuzzy-search code completion engine for Vim.
...
* [Embarcadero Dev-CPP](https://github.com/Embarcadero/Dev-Cpp) ⭐ 2,882 | 🐛 205 | 🌐 Pascal | 📅 2024-06-17 - A fork of Dev-C++ that comes preinstalled with new themes and modern compilers. \[GPLv2] [website](https://www.embarcadero.com/free-tools/dev-cpp)
...
* [Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 26,591 | 🐛 1,365 | 🌐 CMake | 📅 2026-02-07 - C++ library manager for Windows, Linux, and MacOS. \[MIT]
...
* [Sccache](https://github.com/mozilla/sccache) ⭐ 6,984 | 🐛 423 | 🌐 Rust | 📅 2026-02-08 - A fast compiler cache for C/C++, with cross-platform support and cloud backed storage options.
* [Bear](https://github.com/rizsotto/Bear) ⭐ 6,173 | 🐛 6 | 🌐 Rust | 📅 2026-02-08 - A tool to generate compilation database for clang tooling. \[GPLv3]
...
* [Infer](https://github.com/facebook/infer) ⭐ 15,517 | 🐛 407 | 🌐 OCaml | 📅 2026-02-07 - A static analyzer for Java, C and Objective-C. \[BSD]
* [Cppcheck](http://cppcheck.sourceforge.net/) - A tool for static C/C++ code analysis. - [source](https://github.com/danmar/cppcheck) ⭐ 6,494 | 🐛 180 | 🌐 C++ | 📅 2026-02-08
* [include-what-you-use](https://github.com/include-what-you-use/include-what-you-use) ⭐ 4,617 | 🐛 229 | 🌐 C++ | 📅 2026-02-07 - A tool for use with clang to analyze includes in C and C++ source files. [website](https://include-what-you-use.org/)
...
* [IKOS](https://github.com/NASA-SW-VnV/ikos) ⭐ 3,110 | 🐛 43 | 🌐 C++ | 📅 2025-04-24 - Static analyzer for C/C++ based on the theory of Abstract Interpretation. \[NOSA 1.3]
* [cpplint](https://github.com/cpplint/cpplint) ⭐ 1,791 | 🐛 75 | 🌐 Python | 📅 2026-02-02 - A C++ style checker following Google's C++ style guide.
...
* [Uncrustify](https://github.com/uncrustify/uncrustify) ⭐ 3,008 | 🐛 367 | 🌐 C++ | 📅 2026-02-08 - Code beautifier.
...
* [Free C Books](https://github.com/EbookFoundation/free-programming-books/blob/main/books/free-programming-books-langs.md#c) ⭐ 382,310 | 🐛 76 | 🌐 Python | 📅 2026-02-09 - vhf/free-programming-books/C.
* [Free C++ Books](https://github.com/EbookFoundation/free-programming-books/blob/main/books/free-programming-books-langs.md#cpp) ⭐ 382,310 | 🐛 76 | 🌐 Python | 📅 2026-02-09 - vhf/free-programming-books/C++.
* [List of Free C or C++ Books](https://github.com/fffaraz/awesome-cpp/blob/master/books.md) ⭐ 69,616 | 🐛 420 | 📅 2026-01-27
* [cppbestpractices](https://github.com/lefticus/cppbestpractices) ⭐ 8,690 | 🐛 38 | 📅 2024-08-06 - Collaborative Collection of C++ Best Practices.
...
* [google-styleguide](https://github.com/google/styleguide) ⭐ 38,937 | 🐛 173 | 🌐 HTML | 📅 2025-11-13 - Style guides for Google-originated open-source projects.
...
* [List of C or C++ YouTube Videos](https://github.com/fffaraz/awesome-cpp/blob/master/videos.md) ⭐ 69,616 | 🐛 420 | 📅 2026-01-27
...
* [algorithms](https://github.com/xtaci/algorithms) ⭐ 5,440 | 🐛 104 | 🌐 C++ | 📅 2024-08-01 - Algorithms & Data Structures in C++.
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 436,152 | 🐛 68 | 📅 2026-01-28 :zap: - A curated list of awesome lists.
* [free-programming-books](https://github.com/vhf/free-programming-books) ⭐ 382,310 | 🐛 76 | 🌐 Python | 📅 2026-02-09 - List of Freely Available Programming Books.
* [papers-we-love](https://github.com/papers-we-love/papers-we-love) ⭐ 103,116 | 🐛 3 | 🌐 Shell | 📅 2025-10-10 - Papers from the computer science community to read and discuss.
...
* [Projects](https://github.com/karan/Projects) ⭐ 47,390 | 🐛 116 | 📅 2024-08-14 - A list of practical projects that anyone can solve in any programming language.
...
* [awesome-algorithms](https://github.com/tayllan/awesome-algorithms) ⭐ 24,685 | 🐛 0 | 📅 2026-01-11 - A curated list of awesome places to learn and/or practice algorithms.
...
* [lists](https://github.com/jnv/lists) ⭐ 10,944 | 🐛 7 | 📅 2025-05-20 - List of (awesome) lists curated on GitHub.
* [nothings/single\_file\_libs](https://github.com/nothings/single_file_libs) ⭐ 9,781 | 🐛 4 | 📅 2026-02-08 :zap: - List of single-file C/C++ libraries.
...
* [C++ links](https://github.com/MattPD/cpplinks) ⭐ 5,204 | 🐛 1 | 📅 2026-02-09 - A categorized list of C++ resources.
* [awesome-hpp](https://github.com/p-ranav/awesome-hpp) ⭐ 4,054 | 🐛 21 | 📅 2025-11-06 - A curated list of awesome header-only C++ libraries.
...
Please take a quick gander at the [contribution guidelines](https://github.com/fffaraz/awesome-cpp/blob/master/CONTRIBUTING.md) ⭐ 69,616 | 🐛 420 | 📅 2026-01-27 for details.
Thanks to all [contributors](https://github.com/fffaraz/awesome-cpp/graphs/contributors) ⭐ 69,616 | 🐛 420 | 📅 2026-01-27; you rock!
